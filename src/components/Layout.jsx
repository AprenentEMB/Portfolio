...
useEffect(() => {
  ...
  return (
    <div className="flex flex-row bg-gradient-to-br from-black via-teal-900 to-slate-900  ">
      <div className="pl-[11%] text-slate-400 p-6 flex flex-col justify-between fixed left-0 top-0 h-screen z-20">
        <div>
          ...
          <nav className="flex flex-col space-y-3 mt-16 text-xs">
  ...
  {/* GitHub */}
  <a href="https://github.com/enricmoles" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
  ...
  {/* LinkedIn */}
  <a href="https://linkedin.com/in/enricmoles" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
    <svg className="w-6 h-6 hover:text-sky-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
